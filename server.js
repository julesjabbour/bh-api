...
app.get('/api/tts-bh', (req, res) => {
  ...
  try {
    ...
    res.json({ audioContent: audioBase64, encoding: 'wav', inputIPA: ipa, espeakPhon, voice: 'fr', size: audioBuffer.length });
  } catch (e) {
    console.error(`[TTS-BH] Error: ${e.message}`);
